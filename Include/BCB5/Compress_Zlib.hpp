...
// (DO NOT EDIT: machine generated header) 'Compress_Zlib.pas' rev: 5.00
...
private:
	...
	void __fastcall Compress(Classes::TMemoryStream* SourceStream, Classes::TMemoryStream* DestStream, 
		const Zlibunit::TCompressionLevel CompressionLevel);
