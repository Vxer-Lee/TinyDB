...
// (DO NOT EDIT: machine generated header) 'HashBase.pas' rev: 5.00
...
public:
	...
	/*         class method */ static AnsiString __fastcall CalcBuffer(TMetaClass* vmt, void * Digest, 
		const void *Buffer, int BufferSize);
	/*         class method */ static AnsiString __fastcall CalcStream(TMetaClass* vmt, void * Digest, 
		const Classes::TStream* Stream, int StreamSize);
	/*         class method */ static AnsiString __fastcall CalcString(TMetaClass* vmt, void * Digest, 
		const AnsiString Data);
	/*         class method */ static AnsiString __fastcall CalcFile(TMetaClass* vmt, void * Digest, const 
		AnsiString FileName);
