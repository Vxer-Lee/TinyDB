...
// (DO NOT EDIT: machine generated header) 'TinyDB.pas' rev: 5.00
...
public:
	...
	virtual void __fastcall EncodeStream(Classes::TMemoryStream* Source, Classes::TMemoryStream* Dest, 
		int DataSize) = 0 ;
	virtual void __fastcall DecodeStream(Classes::TMemoryStream* Source, Classes::TMemoryStream* Dest, 
		int DataSize) = 0 ;
...
public:
	...
	#pragma option push -w-inl
	/* virtual class method */ virtual int __fastcall CheckAlgoRegistered(const AnsiString AlgoName) { 
		return CheckAlgoRegistered(__classid(TDataProcessMgr), AlgoName); }
	#pragma option pop
	/*         class method */ static int __fastcall CheckAlgoRegistered(TMetaClass* vmt, const AnsiString 
		AlgoName);
...
public:
	#pragma option push -w-inl
	/* virtual class method */ virtual int __fastcall CheckAlgoRegistered(const AnsiString AlgoName) { 
		return CheckAlgoRegistered(__classid(TCompressMgr), AlgoName); }
	#pragma option pop
	/*         class method */ static int __fastcall CheckAlgoRegistered(TMetaClass* vmt, const AnsiString 
		AlgoName);
...
public:
	#pragma option push -w-inl
	/* TDataProcessMgr.Create */ inline __fastcall TCompressMgr(TTinyDBFileIO* AOwner) : TDataProcessMgr(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	...
	#pragma option push -w-inl
	/* virtual class method */ virtual int __fastcall CheckAlgoRegistered(const AnsiString AlgoName) { 
		return CheckAlgoRegistered(__classid(TEncryptMgr), AlgoName); }
	#pragma option pop
	/*         class method */ static int __fastcall CheckAlgoRegistered(TMetaClass* vmt, const AnsiString 
		AlgoName);
	virtual void __fastcall SetAlgoName(const AnsiString Value);
...
public:
	#pragma option push -w-inl
	/* TDataProcessMgr.Create */ inline __fastcall TEncryptMgr(TTinyDBFileIO* AOwner) : TDataProcessMgr(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	void __fastcall DecodeMemoryStream(Classes::TMemoryStream* SrcStream, Classes::TMemoryStream* DstStream
		, bool Encrypt, bool Compress);
	void __fastcall DecodeMemoryBuffer(char * SrcBuffer, char * DstBuffer, int DataSize, bool Encrypt);
		
	void __fastcall EncodeMemoryStream(Classes::TMemoryStream* SrcStream, Classes::TMemoryStream* DstStream
		, bool Encrypt, bool Compress);
	...
	void __fastcall CheckValidIndexFields(const AnsiString * FieldNames, const int FieldNames_Size, TTDIndexOptions 
		IndexOptions, TTableHeader &TableHeader);
	...
	bool __fastcall ReCreate(bool NewCompressBlob, TCompressLevel NewCompressLevel, const AnsiString NewCompressAlgoName
		, bool NewEncrypt, const AnsiString NewEncAlgoName, const AnsiString OldPassword, const AnsiString 
		NewPassword, bool NewCRC32);
...
public:
	...
	/*         class method */ static bool __fastcall CheckValidTinyDB(TMetaClass* vmt, Classes::TStream* 
		ADBStream)/* overload */;
	/*         class method */ static bool __fastcall CheckValidTinyDB(TMetaClass* vmt, const AnsiString 
		FileName)/* overload */;
	/*         class method */ static bool __fastcall CheckTinyDBVersion(TMetaClass* vmt, Classes::TStream* 
		ADBStream)/* overload */;
	/*         class method */ static bool __fastcall CheckTinyDBVersion(TMetaClass* vmt, const AnsiString 
		FileName)/* overload */;
	...
	void __fastcall ReadFieldData(Classes::TMemoryStream* DstStream, int RecTabItemOffset, int DiskFieldOffset
		, int FieldSize, bool IsBlob, bool ShouldEncrypt, bool ShouldCompress)/* overload */;
	void __fastcall ReadFieldData(Classes::TMemoryStream* DstStream, int FieldDataOffset, int FieldSize
		, bool IsBlob, bool ShouldEncrypt, bool ShouldCompress)/* overload */;
	void __fastcall ReadAllRecordTabItems(const TTableHeader &TableHeader, TRecordTabItems &Items, TIntegerAry 
		&BlockOffsets);
	void __fastcall ReadAllIndexTabItems(const TTableHeader &TableHeader, int IndexIdx, TIndexTabItems 
		&Items, TIntegerAry &BlockOffsets);
	void __fastcall WriteDeleteFlag(int RecTabItemOffset);
	bool __fastcall CreateDatabase(const AnsiString DBFileName, bool CompressBlob, TCompressLevel CompressLevel
		, const AnsiString CompressAlgoName, bool Encrypt, const AnsiString EncryptAlgoName, const AnsiString 
		Password, bool CRC32)/* overload */;
	...
	bool __fastcall CreateIndex(const AnsiString TableName, const AnsiString IndexName, TTDIndexOptions 
		IndexOptions, const AnsiString * FieldNames, const int FieldNames_Size);
	...
	bool __fastcall RenameField(const AnsiString TableName, const AnsiString OldFieldName, const AnsiString 
		NewFieldName);
	bool __fastcall RenameIndex(const AnsiString TableName, const AnsiString OldIndexName, const AnsiString 
		NewIndexName);
	bool __fastcall Compact(const AnsiString Password);
	bool __fastcall Repair(const AnsiString Password);
	bool __fastcall ChangePassword(const AnsiString OldPassword, const AnsiString NewPassword, bool Check
		);
	bool __fastcall ChangeEncrypt(bool NewEncrypt, const AnsiString NewEncAlgo, const AnsiString OldPassword
...
#pragma option push -b-
enum TTinyDatabaseEvent { dbOpen, dbClose, dbAdd, dbRemove, dbAddAlias, dbDeleteAlias, dbAddDriver, 
	dbDeleteDriver };
#pragma option pop

typedef void __fastcall (__closure *TTinyDatabaseNotifyEvent)(TTinyDatabaseEvent DBEvent, const void 
	*Param);
...
private:
	...
	TTinyDatabase* __fastcall DoOpenDatabase(const AnsiString DatabaseName, Classes::TComponent* AOwner
		, TTDBDataSet* ADataSet, bool IncRef);
...
public:
	...
	void __fastcall GetFieldNames(const AnsiString DatabaseName, const AnsiString TableName, Classes::TStrings* 
		List);
	void __fastcall GetIndexNames(const AnsiString DatabaseName, const AnsiString TableName, Classes::TStrings* 
		List);
...
public:
	...
	/*         class method */ static int __fastcall GetCompressAlgoNames(TMetaClass* vmt, Classes::TStrings* 
		List);
	/*         class method */ static int __fastcall GetEncryptAlgoNames(TMetaClass* vmt, Classes::TStrings* 
		List);
	...
	bool __fastcall ChangePassword(const AnsiString NewPassword, bool Check);
...
#pragma option push -b-
enum TExprToken { etEnd, etSymbol, etName, etNumLiteral, etCharLiteral, etLParen, etRParen, etEQ, etNE, 
	etGE, etLE, etGT, etLT, etADD, etSUB, etMUL, etDIV, etComma, etAsterisk, etLIKE, etISNULL, etISNOTNULL, 
	etIN };
#pragma option pop
...
#pragma option push -b-
enum TTinyOperator { toNOTDEFINED, toISBLANK, toNOTBLANK, toEQ, toNE, toGT, toLT, toGE, toLE, toNOT, 
	toAND, toOR, toADD, toSUB, toMUL, toDIV, toMOD, toLIKE, toIN, toASSIGN };
#pragma option pop

#pragma option push -b-
enum TTinyFunction { tfUnknown, tfUpper, tfLower, tfSubString, tfTrim, tfTrimLeft, tfTrimRight, tfYear, 
	tfMonth, tfDay, tfHour, tfMinute, tfSecond, tfGetDate };
#pragma option pop
...
public:
	...
	void __fastcall EvaluateOperator(TExprNode* ResultNode, TTinyOperator Operator, TExprNode* LeftNode
		, TExprNode* RightNode, Classes::TList* Args, TStrCompOptions Options);
	...
	/*         class method */ static TTinyFunction __fastcall FuncNameToEnum(TMetaClass* vmt, const AnsiString 
		FuncName);
...
public:
	...
	TExprNode* __fastcall NewNode(TExprNodeKind NodeKind, Db::TFieldType DataType, int ADataSize, TTinyOperator 
		Operator, TExprNode* Left, TExprNode* Right);
...
public:
	...
	virtual Variant __fastcall Calculate(TStrCompOptions Options);
};
...
protected:
	...
	void __fastcall ReadFieldData(Classes::TMemoryStream* DstStream, int FieldDataOffset, int FieldSize
		, bool IsBlob, bool ShouldEncrypt, bool ShouldCompress);
...
private:
	...
	int __fastcall SearchIndexedField(Classes::TList* RecTabList, int IndexIdx, int &ResultState, int EffFieldCount
		, bool PartialCompare);
	int __fastcall SearchIndexedFieldBound(Classes::TList* RecTabList, int IndexIdx, bool LowBound, int 
		&ResultState, int EffFieldCount, bool PartialCompare);
	int __fastcall SearchRangeStart(Classes::TList* RecTabList, int IndexIdx, int &ResultState, int EffFieldCount
		);
	int __fastcall SearchRangeEnd(Classes::TList* RecTabList, int IndexIdx, int &ResultState, int EffFieldCount
		);
	bool __fastcall SearchKey(Classes::TList* RecTabList, int IndexIdx, int EffFieldCount, bool Nearest
		);
	int __fastcall SearchInsertPos(int IndexIdx, int &ResultState);
	void __fastcall SetKeyFields(TTDKeyIndex KeyIndex, const System::TVarRec * Values, const int Values_Size
		)/* overload */;
	void __fastcall SetKeyFields(int IndexIdx, TTDKeyIndex KeyIndex, const System::TVarRec * Values, const 
		int Values_Size)/* overload */;
...
public:
	...
	bool __fastcall FindKey(const AnsiString IndexName, const System::TVarRec * KeyValues, const int KeyValues_Size
		)/* overload */;
	void __fastcall FindNearest(const System::TVarRec * KeyValues, const int KeyValues_Size)/* overload */
		;
	void __fastcall FindNearest(const AnsiString IndexName, const System::TVarRec * KeyValues, const int 
		KeyValues_Size)/* overload */;
	...
	void __fastcall SetRange(const AnsiString IndexName, const System::TVarRec * StartValues, const int 
		StartValues_Size, const System::TVarRec * EndValues, const int EndValues_Size)/* overload */;
...
public:
	#pragma option push -w-inl
	/* TDataProcessAlgo.Create */ inline __fastcall virtual TCompressAlgo(System::TObject* AOwner) : TDataProcessAlgo(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	...
	void __fastcall InternalCodeStream(Classes::TMemoryStream* Source, Classes::TMemoryStream* Dest, int 
		DataSize, bool Encode);
...
public:
	#pragma option push -w-inl
	/* TDataProcessAlgo.Create */ inline __fastcall virtual TEncryptAlgo(System::TObject* AOwner) : TDataProcessAlgo(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
typedef void __fastcall (__closure *TOnAdjustIndexForAppendEvent)(int IndexIdx, int InsertPos, const 
	TMemRecTabItem &MemRecTabItem);

typedef void __fastcall (__closure *TOnAdjustIndexForModifyEvent)(int IndexIdx, int FromRecIdx, int 
	ToRecIdx);
...
private:
	...
	void __fastcall InitIndexDefs(void);
	void __fastcall InitRecTabList(int ListIdx, bool ReadRecTabItems);
	...
	void __fastcall AdjustIndexesForAppend(TFieldBuffers* FieldBuffers, int RecDataOffset, int RecTotal
		, TOnAdjustIndexForAppendEvent OnAdjustIndex);
	void __fastcall AdjustIndexesForModify(TFieldBuffers* FieldBuffers, int EditPhyRecordIdx, TOnAdjustIndexForModifyEvent 
		OnAdjustIndex);
...
public:
	...
	void __fastcall AppendRecordData(TFieldBuffers* FieldBuffers, bool Flush, TOnAdjustIndexForAppendEvent 
		OnAdjustIndex);
	void __fastcall ModifyRecordData(TFieldBuffers* FieldBuffers, int PhyRecordIdx, bool Flush, TOnAdjustIndexForModifyEvent 
		OnAdjustIndex);
	...
	int __fastcall CompFieldData(void * FieldBuffer1, void * FieldBuffer2, Db::TFieldType FieldType, bool 
		CaseInsensitive, bool PartialCompare);
	int __fastcall SearchIndexedField(TFieldBuffers* FieldBuffers, Classes::TList* RecTabList, int IndexIdx
		, int &ResultState, int EffFieldCount, bool PartialCompare);
	int __fastcall SearchIndexedFieldBound(TFieldBuffers* FieldBuffers, Classes::TList* RecTabList, int 
		IndexIdx, bool LowBound, int &ResultState, int EffFieldCount, bool PartialCompare);
	int __fastcall SearchRangeStart(TFieldBuffers* FieldBuffers, Classes::TList* RecTabList, int IndexIdx
		, int &ResultState, int EffFieldCount);
	int __fastcall SearchRangeEnd(TFieldBuffers* FieldBuffers, Classes::TList* RecTabList, int IndexIdx
		, int &ResultState, int EffFieldCount);
	...
	void __fastcall ConvertRecordIdx(int SrcIndexIdx, int SrcRecordIdx, int DstIndexIdx, int &DstRecordIdx
		)/* overload */;
	void __fastcall ConvertRecordIdx(Classes::TList* SrcRecTabList, int SrcRecordIdx, Classes::TList* DstRecTabList
		, int &DstRecordIdx)/* overload */;
	void __fastcall ConvertRecIdxForPhy(int SrcIndexIdx, int SrcRecordIdx, int &DstRecordIdx)/* overload */
		;
	void __fastcall ConvertRecIdxForPhy(Classes::TList* SrcRecTabList, int SrcRecordIdx, int &DstRecordIdx
		)/* overload */;
	void __fastcall ConvertRecIdxForCur(int SrcIndexIdx, int SrcRecordIdx, Classes::TList* RecTabList, 
		int &DstRecordIdx);
...
extern PACKAGE TFieldItem __fastcall FieldItem(AnsiString FieldName, Db::TFieldType FieldType, int DataSize
	, TFieldDataProcessMode DPMode);
extern PACKAGE AnsiString __fastcall PointerToStr(void * P);
extern PACKAGE AnsiString __fastcall HashMD5(const AnsiString Source, void * Digest);
extern PACKAGE AnsiString __fastcall HashSHA(const AnsiString Source, void * Digest);
extern PACKAGE AnsiString __fastcall HashSHA1(const AnsiString Source, void * Digest);
extern PACKAGE unsigned __fastcall CheckSumCRC32(const void *Data, int DataSize);
extern PACKAGE void __fastcall EncryptBuffer(char * Buffer, int DataSize, AnsiString EncAlgo, TEncryptMode 
	EncMode, AnsiString Password);
extern PACKAGE void __fastcall DecryptBuffer(char * Buffer, int DataSize, AnsiString EncAlgo, TEncryptMode 
	EncMode, AnsiString Password);
