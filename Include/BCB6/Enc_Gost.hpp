...
// (DO NOT EDIT: machine generated header) 'Enc_Gost.pas' rev: 6.00
...
public:
	#pragma option push -w-inl
	/* TEncAlgo_Base.Create */ inline __fastcall virtual TEncAlgo_Gost(System::TObject* AOwner) : Encryptbase::TEncAlgo_Base(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
